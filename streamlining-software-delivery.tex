...
Anything that you can treat as construction should be automated~\cite{Fow05}.
...
There is nothing like a tested, integrated system for bringing a sense of reality into a project~\cite{Fow05}. Documentation can hide flaws that have not yet been discovered. Even more, untested code hide plenty of flaws. Test-driven development consists of programmers writing tests as they write production code. The tests are integrated into a continuous integration and build process which in affect results in a stable platform for future development.
