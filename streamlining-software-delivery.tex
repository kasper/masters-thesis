...
Indeed, the leading edge of Continuous Experimentation is even starting to favour experiments over predefined test cases. Instead of rigorously testing features beforehand, automatic analytics are run in production. Heuristics are used to immediately discovers issues and alert about their consequences. Continuous Experimentation has become popular companies building web-products such as Etsy and Twitter~\cite{McK12, New13, Rho14, Wan14}.
