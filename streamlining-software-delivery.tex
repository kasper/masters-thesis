...
Some are even pushing web design philosophies to native apps~\cite{Boh13, GZ14}. The UC Berkeley Solar Vehicle Team is using Travis CI to test their embedded software that powers their solar vehicle~\cite{Ngy15}.
