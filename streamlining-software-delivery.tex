...
The acceleration on digital products and services means the web will become more and more irreplaceable for software-intensive products and services. Internet has provided a platform that has transformed software delivery. The deployment pipeline has generated service-oriented platforms that provide many of the common functionalities involved in software delivery. Using Web as a platform: IAAS, PAAS and SAAS~\cite{ZCB10}.
